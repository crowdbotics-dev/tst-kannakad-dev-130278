"""
Django settings for tst_kannakad_dev_130278 project.
...
ROOT_URLCONF = 'tst_kannakad_dev_130278.urls'
...
WSGI_APPLICATION = 'tst_kannakad_dev_130278.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "tst_kannakad_dev_130278 API",
    "DESCRIPTION": "API documentation for tst_kannakad_dev_130278 App",
    "VERSION": "v1",
}
